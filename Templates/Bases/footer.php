    ...
    <div class="row text-center">
        <div class="col-xl-4 col-md-12">
            <ul class="list-footer list-group list-group-flush">
                ...
                <li class="list-group-item">
                    <a href="/HUMAN_HELP/Controller/CommentCaMarcheController/CommentCaMarcheController.php">
                        Comment ça marche
                    </a>
                </li>
        ...
        <div class="col-xl-4 col-md-12">
            <ul class="list-footer list-group list-group-flush">
                ...
                <li class="list-group-item"><a href="/HUMAN_HELP/Controller/FaqController/faqController.php">FAQ</a></li>
                <li class="list-group-item"><a href="/HUMAN_HELP/Controller/BlogController/listeBlogController.php">Blog</a></li>
            </ul>
        </div>
