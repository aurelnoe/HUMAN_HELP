...
function connexion($message=null,$errorCode=null) 
{
    ...
    <div class="container col-12 col-md-6 col-lg-4 pt-2 my-5 borderGreen rounded">  
        ...
        <form class="form-signin m-auto text-center p-3 formConnexion" action="/HUMAN_HELP/?q=UtilisateurController/utilisateurController?action=connexion" method="POST">
            ...
            <div class="m-auto text-left">
                <a href="/HUMAN_HELP/?q=UtilisateurController/FormulairesUtilisateurController?action=formAjout" >
                    Créer un compte
                </a>
            </div>
            <div class="m-auto text-left">
                <a href="formulairesUtilisateurController?action=modifMdp">Mot de passe oublié</a>
            </div>
        </form>
    </div>
    <?php
...
function formulairesUtilisateur(array $tabAffichageFormUser,$utilisateur=null,$message=null)
{
    ...
    <div class="col-12 col-md-5 container my-4 borderGreen rounded">    
        ...
        <form class="needs-validation p-4" id="formUtilisateur" role="form" action=<?php echo ($action=='update') ? "/HUMAN_HELP/?q=UtilisateurController/UtilisateurController?action=$action&idUtilisateur=$idUtilisateur" 
                                                                                : "/HUMAN_HELP/?q=UtilisateurController/UtilisateurController?action=$action" ?> 
                                                                                method="POST">​
...
function modifMotDePasse()
{
    ...
    <div class="col-md-6 col-lg-4 container pt-2 my-5 border rounded">
        <form class="form-signin m-auto text-center p-3 formConnexion" action="../index" method="POST">
...
function detailUtilisateur($utilisateur = null)
{
    ...
    <div class="container w-100">     
        ...
        <div class="col-10 col-md-6 m-auto">
            <a class="btn btn-primary w-100 my-3 " href="/HUMAN_HELP/?q=UtilisateurController/FormulairesUtilisateurController?action=formModif">
                Modifier les informations personnelles
            </a>
        </div>
        <div class="col-10 col-md-6 m-auto">
            <a class="btn btn-danger w-100 my-3 " href="/HUMAN_HELP/?q=UtilisateurController/UtilisateurController?action=delete&idUtilisateur=<?php echo $utilisateur->getIdUtilisateur() ?>">
