        ...
        <div class="col-12 col-md-5 container my-4 borderGreen rounded">    
            ...
            ​<form class="form p-4" action="utilisateurController.php?action=<?php echo $action; ?>" method="POST" novalidate>
                ...
                <div class="form-group mb-0">
                    ...
                    <input type="text" class="form-control" name="nomUtil" placeholder="" value="<?php echo ($_GET['action'] == 'update') ? $utilisateur->getNomUtil() : ''; ?>" required>
                </div>
            ​
                <div class="mb-2 form-group">
                    <label for="prenom">Prénom</label>
                    <input type="text" class="form-control" name="prenomUtil" placeholder="" value="<?php echo ($_GET['action'] == 'update') ? $utilisateur->getPrenomUtil() : ''; ?>" required>
                </div>   
                ...
                <div class="mb-2 form-group">
                    ...
                    <input type="email" name="mailUtil" value="<?php if(($_GET['action']) == 'update'){echo $utilisateur->getMailUtil();}?>" class="form-control" id="emailUser" aria-describedby="emailHelp" required pattern="^\w{2,}@\w{2,}\.\w{2,}$">
                </div>
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-2 form-group">
                        ...
                        <input type="text" class="form-control" name="villeUtil" id="villeUtil" <?php echo ($_GET['action'] == 'update') ? $utilisateur->getVilleUtil() : ''; ?> required>
                    </div>
